...
const LoginPage=()=> {
  ...
  return (
    <div className='min-h-screen bg-cover bg-centre flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col
    backdrop-blur-2xl'>
       ...
       />
        ...
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          ...
          <div className='flex flex-col gap-2'>
            {currState === "Sign up" ? (
              <p className='text-sm text-gray-600'>Already have an account? <span onClick={()=>{setCurrState("Login"); setIsDataSubmitted}} className='font-medium text-violet-500 cursor-pointer'>Login here</span></p>
            ) :(
